    ...
    context = {
        "asignaturas":{
            lc:{
                ...
                "HORA DE LECTURA: MI HÉROE ERES TÚ!":[["MI_HÉROE_ERES_TÚ__hablandodelcuento.pdf", cpt], ["My Hero is You, Storybook for Children on COVID-19 (Spanish)_1.pdf", cpt]],
            },
            lg:{
                ...
                "ESPRESIÓN ESCRITA": [["EXPRESIÓN_ESCRITA_1.pdf", cpt]]
            },
            mt:{
                ...
                "MITAD, TERCIO Y CUARTO":[["mitad_tercio_cuarto.pdf", cpt]],
