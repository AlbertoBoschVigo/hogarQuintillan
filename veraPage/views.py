    ...
    context = {
        "asignaturas":{
            ...
            lg:{
                ...
                "Repaso ortografía" : [["aprendo_mais.pdf", cpt], ["signos_interrogacion_admiracion.pdf", pdt]],
            ...
            cn:{
                "Tema3_SOMO DISTINTOS DOUTROS ANIMAIS" : [["t3_cn.pdf", pdt]],
                "QUEDA NA CASA" : [["3_CN_QUEDANACASA.pdf", cpt]],
                "O NOSO LABORATORIO" : [["O noso laboratorio.pdf", pdt]],
                "ES VIERNES!!" : [["ES VIERNES.pdf", cpt]],        
                "O NOSO CORPO" : [["O_NOSO_CORPO.pdf", cpt], ["cn_ep3_48_49_etiquetar.pdf", pdt], ["cn_ep3_50_51_etiquetar.pdf", pdt]],    
            },
            cs:{
                "Construir unha andavía" : [["cs_construir_unhaandavía.pdf", cpt]],
                "CONSTRÚE UN FÓSIL NA CASA" : [["FÓSILES.pdf", pdt]],
                "O NOSO LABORATORIO" : [["3_Experimentos con auga.pdf", pdt]],
                "CICLO DA AUGA" : [["ciclo_d_auga.pdf", pdt]],
                "A auga" : [["BOYAN SLAT. MISIÓN SALVAR O OCÉANO.pdf", pdt], ["ciclo_auga_paisaxes.pdf", pdt]],
                "LLUVIAS EXTRAÑAS":[["LLUVIAS_EXTRAÑAS.pdf", pdt]],
            },
            pl:{
            ...
            ing:{
                ...
                "Vídeos, xogos e máis." : [["ACTIVIDAD", pdt]],
                "STORY TIME: THE GRUFFALO" : [["ACTIVIDADES THE GRUFFALO", pdt]],
                "WHAT IS JESSIE DOING?" : [["ACTIVIDAD", pdt]],
                "STORY TIME: MR CROCODILE'S TOOTHBRUSH" : [["ACTIVIDADES MR CROCODILE", pdt]],
                "Inspector Clouseau sketch":  [["ACTIVIDAD", pdt]],
                "STORY TIME: PEACE AT LAST" : [["ACTIVIDADES PEACE AT LAST", pdt]],
            }          
        }
    }
